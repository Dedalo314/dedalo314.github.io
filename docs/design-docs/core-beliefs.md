...
1. **Verify, Don't Trust:** If you write code, you must verify it. Use `npx playwright test` for end-to-end verification. For UI modifications, include screenshots in the walkthrough as part of the verification evidence. Ensure LaTeX renders as expected and dynamic components load correctly.
